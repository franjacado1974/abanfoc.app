...
import PartesTecnico from '../components/PartesTecnico';
import RevisionChecklist from '../../RevisionChecklist';
import Albaranes from '../../oficina/pages/Albaranes';
import Catalogo from '../../oficina/pages/Catalogo';
import Clientes from '../../oficina/pages/Clientes';
import Centros from '../../oficina/pages/Centros';
import Buzon from '../../oficina/pages/Buzon';
...
type TecnicoView = 'dashboard' | 'partes' | 'albaranes' | 'clientes' | 'centros' | 'catalogo' | 'buzon' | 'calendario';
...
function DashboardHome({ loggedUser, onLogout, onNavigate }: DashboardTecnicoProps & { onNavigate: (view: TecnicoView) => void }) {
  ...
  const cards = [
    ...
    },
    {
      ...
      title: 'Calendario',
      description: 'Planificación de trabajos, revisiones y averías',
      icon: Calendar,
      bgColor: 'bg-rose-50',
      ...
      badgeLabel: 'Planificación',
      clickable: true,
      stats: [
        { label: 'Eventos del mes', value: stats.partesPendientes },
      ],
    },
    {
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="mt-12 text-center">
          <p className="text-xs text-zinc-400">
            Sesión activa como <span className="font-semibold text-zinc-600">{loggedUser?.nombre || (loggedUser as any)?.usuario || 'Técnico'}{loggedUser?.apellidos ? ` ${loggedUser.apellidos}` : ''}</span>
            {' · '}
            <button
              onClick={handleLogout}
