...
import { generarActaExtintoresPDF, generarAlbaranPDF, generarCertificadoPDF } from '../../recursos-compartidos/services/pdfGenerator';
...
export default function Partes() {
  ...
  }, [partes, estadoFilter, search, centros, clientes]);

  // Show all parts, including those without a fechaProgramada
  const partesPlanificados = useMemo(() => {
    return partesFiltrados.filter(p => {
  ...
  }, [partesFiltrados, startDate, endDate]);
