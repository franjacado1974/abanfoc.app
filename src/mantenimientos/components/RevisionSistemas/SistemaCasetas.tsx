...
export default function SistemaCasetas({
    sist,
    filteredEqs,
    equiposInstalados,
        ...
        <>
            {                                                    filteredEqs.map((eq, i) => {
                                                        ...
                                                        const item70Fab = itemsToUse.find(i => {
                                                         ...
                                                         if (item70Fab) {
                                                             const val = eq[item70Fab.key as keyof EquipoInstalado] as string;
                                                             if (val) {
                                                                 ...
                                                                 if (!isNaN(d.getTime())) {
                                                                     ...
                                                                     if (diff >= 20) caducado70 = true;
                                                                 }
                                                             }
                                                         }
                                                         if (item70PH) {
                                                             const val = eq[item70PH.key as keyof EquipoInstalado] as string;
                                                             if (val) {
                                                                 const today = new Date();
                                                                 const d = new Date(val);
                                                                 if (!isNaN(d.getTime())) {
                                                                     let diff = today.getFullYear() - d.getFullYear();
                                                                     if (today.getMonth() < d.getMonth() || (today.getMonth() === d.getMonth() && today.getDate() < d.getDate())) diff--;
                                                                     if (diff >= 5) necesitaPrueba70 = true;
                                                                 }
                                                             }
                                                         }
                                                         if (item45Fab) {
                                                             const val = eq[item45Fab.key as keyof EquipoInstalado] as string;
                                                             if (val) {
                                                                 const today = new Date();
                                                                 const d = new Date(val);
                                                                 if (!isNaN(d.getTime())) {
                                                                     let diff = today.getFullYear() - d.getFullYear();
                                                                     if (today.getMonth() < d.getMonth() || (today.getMonth() === d.getMonth() && today.getDate() < d.getDate())) diff--;
                                                                     if (diff >= 20) caducado45 = true;
                                                                 }
                                                             }
                                                         }
                                                         if (item45PH) {
                                                             const val = eq[item45PH.key as keyof EquipoInstalado] as string;
                                                             if (val) {
                                                                 const today = new Date();
                                                                 const d = new Date(val);
                                                                 if (!isNaN(d.getTime())) {
                                                                     let diff = today.getFullYear() - d.getFullYear();
                                                                     if (today.getMonth() < d.getMonth() || (today.getMonth() === d.getMonth() && today.getDate() < d.getDate())) diff--;
                                                                     if (diff >= 5) necesitaPrueba45 = true;
                                                                 }
                                                             }
                                                         }
                                                                                              ...
                                                                                              {isCheck ? (
                                                                                                  ...
                                                                                                  (() => {
                                                                                                      ...
                                                                                                      const fechaVal = typeof val === 'string' && val 
                                                                                                          ? (esFechaRevision ? val.substring(0, 10) : val.substring(0, 7)) 
                                                                                                          : '';
                                                                                                      const isErrorDate = 
                                                                            (item.key === item70Fab?.key && caducado70) ||
                                                                            (item.key === item70PH?.key && necesitaPrueba70) ||
                                                                            (item.key === item45Fab?.key && caducado45) ||
                                                                            (item.key === item45PH?.key && necesitaPrueba45);
                                                                                                      const hoyStr = new Date().toISOString().split('T')[0];
                                                                                                      const noEsHoy = esFechaRevision && fechaVal !== hoyStr;
                                                                                                      return (
                                                                                                          <input
