...
export const oficinaRoutes = [
  ...
  { path: '/configuracion-datos', component: ConfiguracionEmpresa, allowedRoles: ['super-administrador', 'superusuario', 'superadministrador'] },
  { path: '/ajustes', component: Ajustes, allowedRoles: ['super-administrador', 'superusuario', 'superadministrador'] },
