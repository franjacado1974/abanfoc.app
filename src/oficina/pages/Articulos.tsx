...
import ConfirmationModal from '../../recursos-compartidos/ConfirmationModal'; // Import the new modal component
...
} from '../../recursos-compartidos/firebase/firebase'; // Assuming firebase.ts also uses SistemaCategoria internally or exports it
