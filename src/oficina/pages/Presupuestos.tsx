...
import type { Presupuesto, PresupuestoLinea, Cliente, Articulo, Centro } from '../../recursos-compartidos/firebase/firebase';
import { generarPresupuestoPDF } from '../../recursos-compartidos/services/pdfGenerator';
