...
export default function SistemaAbastecimientoSalaBombas({
    sist,
    filteredEqs,
    equiposInstalados,
                                                            ...
                                                            <div key={eq.id} id={`equipo-${eq.id}`} className={`scroll-mt-44 rounded-xl border transition-all ${algunCheckRojo ? 'bg-red-50/30 border-red-200' : 'bg-slate-50 border-slate-150'}`}>
                                                                ...
                                                                <div className="px-4 pb-3">
                                                                            ...
                                                                            const val = (rawVal === undefined || rawVal === '')
                                                                             ...
                                                                             const labelUpperAbast = (item.label || '').toUpperCase();
                                                                              ...
                                                                              if (isAbastecePregunta) {
                                                                                 const opcionesDefault = ['BIEs', 'Hidrantes', 'Rociadores / Sprinklers', 'Espuma', 'Otros'];
                                                                                 const opcionesRaw = (item as any).opciones || [];
                                                                                 const opciones = opcionesRaw.length > 0 ? opcionesRaw : opcionesDefault;

                                                                                 const currentSelected: string[] = typeof val === 'string'
                                                                                     ? val.split(',').map((s: string) => s.trim()).filter(Boolean)
                                                                                     : (Array.isArray(val) ? val : []);

                                                                                 return (
                                                                                     <div key={item.key} className="col-span-full border-b border-slate-100 pb-3 pt-3 flex flex-col gap-2">
                                                                                         ...
                                                                                         <div className="flex gap-2 flex-wrap">
                                                                                             {opciones.map((opt: string, idx: number) => {
                                                                                                 ...
                                                                                                 const handleClick = () => {
                                                                                                     ...
                                                                                                     if (isSelected) {
                                                                                                         newSelected = currentSelected.filter((s: string) => s !== opt);
                                                                                                     } else {
                                                                                                         newSelected = [...currentSelected, opt];
                                                                                                     }
                                                                                                     handleCheckChange(eq.id, item.key, newSelected.join(', '), item.label);
                                                                                                 };
                                                                                                 ...
                                                                                                 return (
                                                                                                     <button
                                                                                                         ...
                                                                                                         type="button"
                                                                                                         onClick={handleClick}
                                                                                                         className={`px-3.5 py-1.5 rounded-xl text-xs font-bold border transition-all cursor-pointer select-none shadow-sm flex items-center gap-1.5 ${
                                                                                                             isSelected
                                                                                                                 ? 'bg-indigo-600 text-white border-indigo-600 shadow-md scale-105'
                                                                                                                 : 'bg-slate-100 text-slate-800 border-slate-300 hover:bg-slate-200 hover:text-black font-semibold'
                                                                                                         }`}
                                                                                                     >
                                                                                                               ...
                                                                                                               {opciones.map((opt: string, idx: number) => {
                                                                                                                   ...
                                                                                                                   return (
                                                                                                                       <button
                                                                                                                           ...
                                                                                                                           type="button"
                                                                                                                           onClick={handleClick}
                                                                                                                           className={`px-3.5 py-1.5 rounded-xl text-xs border transition-all cursor-pointer select-none shadow-sm flex items-center gap-1.5 ${
                                                                                                                               isSelected
                                                                                                                                   ? 'bg-indigo-600 text-white border-indigo-600 font-bold shadow-md scale-105'
                                                                                                                                   : 'bg-slate-100 text-slate-500 border-slate-200 hover:bg-slate-200 hover:text-slate-700 font-medium'
                                                                                                                           }`}
                                                                                                                       >
                                                                                                                          ...
                                                                                                                          className={`px-2.5 py-1 rounded-lg text-xs font-semibold border transition-all cursor-pointer select-none shadow-sm ${
                                                                                                                              isSelected
                                                                                                                                  ? (() => {
                                                                                                                                      ...
                                                                                                                                      if (optUpper.includes('NO CORRECTO') || optUpper.includes('NO CONFORME') || optUpper === 'INCORRECTO' || optUpper.includes('ANOMAL') || optUpper.includes('PENDIENTE') || optUpper.includes('DEFECTO') || optUpper.includes('FALLO') || optUpper.includes('INOPERAT')) return 'bg-red-600 text-white border-red-600 font-bold scale-105 shadow-md';
                                                                                                                                      if (optUpper.includes('CORRECTO') || optUpper.includes('CONFORME')) return 'bg-green-600 text-white border-green-600 font-bold scale-105 shadow-md';
                                                                                                                                      return 'bg-indigo-600 text-white border-indigo-600 font-bold scale-105 shadow-md';
                                                                                                                                    })()
                                                                                                                                  : (() => {
                                                                                                                                      const optUpper = (opt || '').toUpperCase().trim();
                                                                   ...
                                                                   {(() => {
                                                                       ...
                                                                       const isErrorAnom = esNoEncontrado || algunCheckRojo || esAvisoAutoMsg || tieneValorAnom;
