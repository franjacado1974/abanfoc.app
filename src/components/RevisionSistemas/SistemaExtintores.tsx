                                                                                  ...
                                                                                  return (
                                                                                      <div key={item.key} className="col-span-full border-b border-slate-100 pb-2 pt-2 flex items-center justify-between gap-4">
                                                                                          ...
                                                                                          <input
                                                                                              ...
                                                                                              className="w-48 px-2.5 py-1.5 bg-white border border-slate-200 rounded-lg text-xs outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20"
                                                                                              placeholder="..."
                                                                                          />
                                                                                      </div>
                                                                                  );
