                                                                                          ...
                                                                                          onClick={async () => {
                                                                                              ...
                                                                                              if (equipoModificado) {
                                                                                                  if (handleGuardarEquipoManual) {
                                                                                                      ...
                                                                                                      try { await updateEquipoInstalado(eq.id, equipoModificado as any, (equipoModificado as any).centroId, (equipoModificado as any).sistemaId); } catch (err) { console.error('Error al actualizar retimbre en Firestore:', err); }
                                                                                                  }
                                                                                              }
