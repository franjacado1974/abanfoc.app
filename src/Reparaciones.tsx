...
import { 
  ...
  type ReparacionItem, type Albaran, type Cliente, type Centro, type Empresa, type Presupuesto, type Pedido 
} from './firebase';
...
export default function Reparaciones() {
  ...
  const handleDescargarPDV = async (item: ReparacionItem) => {
    ...
    await generarPresupuestoPDF({
      titulo: matchPresupuesto?.titulo || matchPedido?.titulo || `Reparación: ${item.reparacion}`,
