...
const endList = lines.findIndex((l, idx) => idx > startList && l.includes('})') && lines[idx+1].includes(');') && lines[idx-1].includes('</div>'));

console.log('Replacing from', startList, 'to', endList);
